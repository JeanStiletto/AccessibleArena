...
$outputPath = "C:\Users\fabia\arena\analysis_core_menus.txt"
...
try {
    ...
    $keywords = @('Login', 'Auth', 'Account', 'Menu', 'Dialog', 'Modal', 'Scene', 'Screen', 'Panel', 'Navigation', 'Button', 'Overlay', 'View', 'Controller', 'Manager', 'UI', 'Selectable', 'Focus')
    ...
    $output = @()
    $output += "MTGA Core.dll Analysis - Menu/UI/Navigation Related Classes"
