    ...
    public class CombatNavigator
    {
        ...
        private bool TryClickBlockerConfirmButton()
        {
            ...
            foreach (var selectable in GameObject.FindObjectsOfType<Selectable>())
            {
                ...
                string buttonText = GetButtonText(selectable.gameObject);
        ...
        /// <summary>
        /// Extracts text from a button GameObject.
        /// </summary>
        ...
        /// <summary>
        /// Cleans text by removing rich text tags and normalizing whitespace.
        /// </summary>
