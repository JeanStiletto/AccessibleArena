...
- [x] Find card database/localization system
- [x] Create basic mod with Harmony patches
- [x] Implement hover card announcement
- [x] Implement navigation announcements
- [x] Implement game phase announcements

See `docs/MOD_STRUCTURE.md` for current implementation status.
