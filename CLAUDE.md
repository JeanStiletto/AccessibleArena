...
Ctrl+Right (Copy current item — the last announcement — to the clipboard; works everywhere: own name+ID in friends list, card names, any focused element)
